...
<body>
    ...
    <div id="content" align="center" class="mx-auto" style="width: 100%;">
        <img align="left" alt="despacho contable enriquez y asociados" src="img/icon2.jpg" width="275" alt="http://enriquezyasocs.000webhostapp.com/"> <br><br><button onclick="javascript:window.print()" align="center" type="button" class="btn btn-primary btn-sm">Imprimir recibo o pdf <i class="fa fa-print" aria-hidden="true"></i></button>
