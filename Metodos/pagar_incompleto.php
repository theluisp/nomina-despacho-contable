...
$sql="UPDATE clientes SET pago = 'SI' ,fecha_pagoactual='$curdate',  pago_parcial=$pago_especial WHERE id='$id' ";
...
setTimeout('Redirect()', 4000);</script>";
     ...
     $var3="Error al actualizar pago, por favor introduzca un valor valido de pago incompleto." ;
echo "<script>alert('$var3');window.history.back();
setTimeout('Redirect()', 4000);</script>";
