...
<body style="background-color:#EADFEA ">
    <div class="wraper d-flex align-items-stretch" style="color:#0489B1;">
        ...
        <div class="ima" id="ima"><center>
            <form action="comentario.php" align="center" method="post">

                <div id="content">
                    <br><br><br>
                    <h4 style="color:black">Añadir comentario para <br> <?php $_GET['varfecha'];
                        $id=$_GET['id'];
                    ...
                    <div class="form-group">
                        <textarea cols="34" rows="4" name="comentario" id="exampleFormControlTextarea1" rows="10"></textarea>
                ...
                <button style=" background-color: #99CCFF" type="submit" class="btn btn-light" align="center">Registrar</button> <a href="javascript:history.back()" style="color:red;"> <b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cancelar</b></a>
                <br><br>
