    ...
    <div class="wraper d-flex align-items-stretch" style="color:#0489B1;">
        <nav id="sidebar">
            <div class="p-4" pt5>
                ...
                <ul class="list-unstyled components mb-5">
                    ...
                    <li class="active">
                        <a href="#"> <i class="fa fa-chevron-circle-right" aria-hidden="true"></i> <b> Cancelar Pago</b></a>
                    </li>



                    <li>
                        <a href="select.php"> <i class="fa fa-arrow-left" aria-hidden="true"></i> Inicio</a>

                    </li>
                    <li>
                        <a href="destruir.php"> <i class="fa fa-lock" aria-hidden="true"></i> Cerrar sesión</a>
                    </li>
                </ul><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><img align="center" alt="despacho contable enriquez y asociados" src="img/icon3.jpg" width="75" alt="http://enriquezyasocs.000webhostapp.com/">
            </div>
        </nav>
        <div id="content" class="mx-auto" style="width: 100%;">
            ...
            <h1><?php $bd= $_GET['var1'];
                $var2= $_GET['var2'];
                $var3= $_GET['var3'];
                echo "Pago por equivocación ". $bd."  ".$var2." ".$var3." <img src='https://img.icons8.com/officel/54/000000/cancel.png'/>"; ?></h1>
            <form>
                ...
                <table id="datos" class="table ">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <td scope="col"><b>Pago</b></td>


                            <td><b>Cancelar pago</b></td>
...
include('Metodos/conexion.php');
                    ...
                    <tr>
                        ...
                        echo "<a href='Metodos/cancelar2.php?var=$id' onclick='return confirmar()'> <img src='https://img.icons8.com/officel/54/000000/cancel.png'/></button></a>"; ?></td>
...
<script>
    function confirmar() {
        if (confirm('¿Esta seguro de cancelar pago?'))
            return true;
        else
            return false;
    }
